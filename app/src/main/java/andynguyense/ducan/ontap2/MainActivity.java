package andynguyense.ducan.ontap2;
...
//        addSample();
    ...
    public void addSample() {
        db.insertPJ(new Project("Test", "18/09/1997", "Annguyen"));
        db.insertPJ(new Project("CMS", "18/09/1997", "Annguyen"));
        db.insertPJ(new Project("WEB", "18/09/1997", "Annguyen"));
        db.insertPJ(new Project("AI", "18/09/1997", "Annguyen"));
        db.insertPJ(new Project("ERB", "18/09/1997", "Annguyen"));
    }
